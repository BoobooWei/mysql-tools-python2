...
class GetReport:
    ...
    def render_template(self, TEMPLATE_DIR):
        with codecs.open(TEMPLATE_DIR + '/' + 'data_check.html', 'r', 'utf-8') as f:
            template_data = f.read()
            template = Template(template_data)

            render_data = {
                'a': self.params['a'],
                "dbhostname": self.params['dbhostname'],
                "now_time": self.params['now_time'],
                "current_time": self.params['current_time']
            }
